...
public interface StadiumRepository extends JpaRepository<Stadium, Integer> {
    Optional<Stadium> findByXAndYAndCategory(float x, float y, StadiumCategoryEnum category);
    List<Stadium> findAllByCategoryAndLocation(StadiumCategoryEnum category, LocationEnum location);
    List<Stadium> findAllByCategoryAndLocationIn(StadiumCategoryEnum category, List<LocationEnum> location);
    ...
    List<Stadium> findAllBetweenLocationAndByCategory(@Param("category") StadiumCategoryEnum category, @Param("startX") float startX, @Param("endX") float endX, @Param("startY") float startY, @Param("endY") float endY);
